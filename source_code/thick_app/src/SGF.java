...
/**
* Cette classe permet de lire dans un fichier pour en extraire les valeurs des consignes et des événements, pour les affectées aux attributs correspondants. Elle permet également d'écrire un rapport de log.
...
public class SGF {
	...
	/**
	* Température à laquelle on coupe le chauffage.
	*/
	public float TemperatureConsigneMoins;
	/**
	* Température à laquelle on déclenche le chauffage.
	*/
	public float TemperatureConsignePlus;
	/**
	* Tolérance de température qui va nous permettre de définir les seuils critiques de températures.
	*/
	public float ToleranceTemperature;
	/**
	* Niveau d'eau à partir duquel on déclenche l'alarme.
	*/
	public float NiveauConsigne;
	/**
	* Niveau de pH où on déclenche le bicarbonate de soude.
	*/
	public float PhMoins;
	/**
	* Niveau de pH où on déclenche le CO2.
	*/
	public float PhPlus;
	/**
	* Tolérance de pH qui va nous permettre de définir les seuils critiques de pH.
	*/
	...
	/**
	* Heure à laquelle on allume le néon 1.
	*/
	public int heureNeon1_Marche;
	/**
	* Minute à laquelle on allume le néon 1.
	*/
	public int minuteNeon1_Marche;
	/**
	* Heure à laquelle on allume le néon 2.
	*/
	...
	*/
	...
	/**
	* Heure à laquelle on arrête le néon 1.
	*/
	public int heureNeon1_Arret;
	/**
	* Minute à laquelle on arrête le néon 1.
	*/
	public int minuteNeon1_Arret;
	/**
	* Heure à laquelle on arrête le néon 2.
	*/
	public int heureNeon2_Arret;
	/**
	* Minute à laquelle on arrête le néon 2.
	*/
	public int minuteNeon2_Arret;
	/**
	* Heure à laquelle on déclenche la première distribution de nourriture.
	*/
	public int heureNourriture1_Marche;
	/**
	* Minute à laquelle on déclenche la première distribution de nourriture.
	*/
	public int minuteNourriture1_Marche;
	/**
	* Heure à laquelle on déclenche la deuxième distribution de nourriture.
	*/
	public int heureNourriture2_Marche;
	/**
	* Minute à laquelle on déclenche la deuxième distribution de nourriture.
	*/
	public int minuteNourriture2_Marche;
	/**
	* Heure à laquelle on déclenche la troisième distribution de nourriture.
	*/
	public int heureNourriture3_Marche;
	/**
	* Minute à laquelle on déclenche la troisième distribution de nourriture.
	*/
	...
	/**
	* Jour de la semaine où on distribut l'engrais.
	*/
	public int jourEngrais_Marche;
	/**
	* Heure où on distribut l'engrais.
	*/
	public int heureEngrais_Marche;
	/**
	* Minute où on distribut l'engrais.
	*/
	...
	*/
	private static String nomfichierConsignes = "consignes.dat";
        /**
	* Nom du fichier d'événements (evenements.dat).
	*/
	...
	*/
	...
	/**
	* Récupére la valeur de la consigne passée en paramètre.
	* @param grandeurRecup Chaine de caractères à chercher dans le fichier.
	* @return La valeur correspondante à la chaine passée en paramètre.
	*/
	...
	/**
	* Récupére la valeur de l'événement passé en paramètre.
	* @param grandeurRecup Chaine de caractères à chercher dans le fichier.
	* @return La valeur correspondante à la chaine passée en paramètre.
	*/
	...
	* @param messageAlarme Message décrivant l'erreur.
	*/
	...
	/**
	* Méthode affectant toutes les consignes et événements lu dans les fichiers ascii correspondant, aux attributs correspondants. Si les fichiers sont absents alors on charge des valeurs par défauts et on regénére un fichier avec les consignes et événements par défauts.
	*/
